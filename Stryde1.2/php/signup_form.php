...
<div id="signup_form_div" class="uk-placeholder uk-text-center uk-margin-bottom">
	...
	<h3>Address</h3> <input class="uk-input uk-form-width-large" type="text" name="address" required></br>
	<input class="uk-input uk-form-width-large" type="text" name=""></br></br>
	<h3>Password:</h3> <input class="uk-input uk-form-width-large" type="password" name="password" required>
